...
# generate predefined.h automatically
def write_header(in_package_name, in_api_key, in_keystore_sha1):
    f = open('configure/predefined.h', 'w')
...
print '[configure/predefined.h created]'
print '--------------------------------------------'
os.system('cat configure/predefined.h')
print '--------------------------------------------'

print '[make clean]'
os.system('make clean')

print '[make encryption]'
os.system('make encryption')
