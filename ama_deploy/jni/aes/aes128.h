...
//	byte plain[16] = {0x32, 0x00, 0x31, 0xe0,
//					0x43, 0x5a, 0x31, 0x37,
//					0xf6, 0x30, 0x98, 0x07,
//					0xa8, 0x8d, 0xa2, 0x34};
//	// 输出密钥
...
//int main()
//{
//	string keyStr = "tulingdemimahaha";
//	byte key[16];
...
//    FILE *ins;
//    ins=fopen("./params","rb") ;
//	in.open("./params", ios::binary);
//	out.open("./testEncrypt", ios::binary);
////	while(in.read((char*)&data, sizeof(data)))
//while(fread((char*)&data,1,16, ins))
//	{
...
//   
//	in.open("./testEncrypt", ios::binary);
//	out.open("./paramsDecrypt", ios::binary);
//	while(in.read((char*)&data, sizeof(data)))
//	{
//		divideToByte(plain, data);
//		decrypt(plain, w);
